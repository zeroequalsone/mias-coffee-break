    ...
    <div className="mt-6 bg-brown-dark text-center text-orange-dark">
      <div className="flex flex-col max-w-4xl mx-auto p-8 lg:p-12 gap-6">
        ...
        <p className="lg:text-xl">
          ...
          Unsere Vision ist es, einen Ort zu schaffen, an dem Menschen eine
          echte Pause vom Alltag machen können.
        </p>
        <p className="text-sm italic max-w-sm mx-auto">
          Inspiriert von italienischen Kaffeehäusern, wo jeder Schluck und jeder
          Bissen eine Geschichte erzählt.
        </p>
      </div>
    </div>
  );
